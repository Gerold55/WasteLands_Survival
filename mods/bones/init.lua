...
--this function is from default mod, just put copied and pasted it here because WLS doesn't use default mod
function bones.node_sound_gravel_defaults(table)
	table = table or {}
...
--this function is from default mod, just put copied and pasted it here because WLS doesn't use default mod
function bones.get_hotbar_bg(x,y)
	local out = ""
	for i=0,7,1 do
...
--this is the bones mod from mtg, just made it usable here cause why not :P --olliy--
...
minetest.register_node("bones:bones", {
	...
	sounds = bones.node_sound_gravel_defaults(),
